...
<a href='https://sciencebase.usgs.gov/nabat/#/home'><img style="position: absolute; top: 0; left: 30px ; border: 0; width:250px;" src='nabat_logo.png' /></a>

# NABat Interactive Acoustic Report: **`r project_id`**
#### **Project**:  `r project_name`

### Locations of all the acoustic data for this project
```{r, echo = FALSE, warning = FALSE, message = FALSE}
leaflet(width = '100%') %>% addTiles() %>% setView(lat = 40.5, lng = -105, zoom = 10)
```
