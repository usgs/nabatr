...
vignette: >
  %\VignetteIndexEntry{Get Covariate Data for All GRTS in a sample frame}
...
grts_covars = get_grts_covariate(token_, branch = branch_, covariate_id = covariate_id, sample_frame_id = sample_frame_id)
